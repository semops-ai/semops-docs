...
This project demonstrates the pattern. See [GLOBAL_ARCHITECTURE.md](https://github.com/semops-ai/semops-orchestrator/blob/main/docs/GLOBAL_ARCHITECTURE.md) for the full multi-repo structure modeling an organization with bounded contexts.

```
semops-orchestrator (Platform/DX)             <- Orchestrator, process docs, global architecture
    │
...
- [UBIQUITOUS_LANGUAGE.md](https://github.com/semops-ai/semops-data/blob/main/schemas/UBIQUITOUS_LANGUAGE.md) - Ground truth schema
...
- [GLOBAL_ARCHITECTURE.md](https://github.com/semops-ai/semops-orchestrator/blob/main/docs/GLOBAL_ARCHITECTURE.md) - Multi-repo structure
