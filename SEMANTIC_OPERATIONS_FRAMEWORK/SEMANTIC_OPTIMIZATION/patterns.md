...
In the SemOps implementation, the [constraints pattern](https://github.com/semops-ai/semops-orchestrator/blob/main/docs/domain-patterns/constraints.md) defines pattern-level invariants — rules that apply to the pattern as a whole, not to individual fields:
