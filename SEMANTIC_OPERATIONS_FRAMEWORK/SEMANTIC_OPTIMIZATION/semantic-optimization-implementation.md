...
- [semops-data domain-patterns/](https://github.com/semops-ai/semops-data/tree/main/docs/domain-patterns) - Pattern documentation
- [semops-data UBIQUITOUS_LANGUAGE.md](https://github.com/semops-ai/semops-data/blob/main/schemas/UBIQUITOUS_LANGUAGE.md) - Schema definitions

### DX Hub

- [semops-orchestrator PROCESS.md](https://github.com/semops-ai/semops-orchestrator/blob/main/docs/PROCESS.md) - Development processes
- [semops-orchestrator GLOBAL_ARCHITECTURE.md](https://github.com/semops-ai/semops-orchestrator/blob/main/docs/GLOBAL_ARCHITECTURE.md) - Multi-repo architecture
