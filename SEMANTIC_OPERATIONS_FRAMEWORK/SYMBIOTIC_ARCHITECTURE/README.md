...
pattern: symbiotic-architecture
...
## How Symbiotic Architecture Maps to the Semantic Funnel

Within this framework, architecture represents the most important rules encoded in the scaffolding of an organization. Symbiotic Architecture spans all three transitions of the [Semantic Funnel](../../RESEARCH/FOUNDATIONS/semantic-funnel.md)—it provides the structural scaffolding through which data objects flow and meaning is constructed.
...
Conway's Law observes that system architecture mirrors organizational structure. Symbiotic Architecture requires organizational alignment: teams structured around domain boundaries rather than technical layers, consistent precision about definitions and rules, and cultural commitment to explicitness over convenience.

→ [Symbiotic Enterprise](symbiotic-enterprise.md)

### Agentic Coding at Scale

How the principles of Symbiotic Architecture apply specifically to AI-assisted software development and agentic coding workflows.
